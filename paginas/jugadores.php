...
<!-- Modal: Editar fecha vencimiento (Club) -->
        ...
        <div class="modal-content modal-login-caja">
            ...
            <div class="modal-body">
                <form action="../sql/editar_fecha_vencimiento.php" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="editar_carnet_vencimiento_fecha" class="form-label">Carnet de Vencimiento</label>
                    ...
                    <button class="btn btn-primary" style="background-color:#226846;border-color:#1a4731;"
                        name="btneditarfecha" value="ok">Confirmar</button>
                </form>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                ...
                <table class="table table-bordered text-start mt-2">
                    <tr><th>Nombre</th><td id="carnet_nombre"></td></tr>
